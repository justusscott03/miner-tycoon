export class MoneyFormatter {
    private static numberLetters = [
        "K", "B", "M", "T",
        "aa", "ab", "ac", "ad", "ae", "af", "ag", "ah", "ai", "aj", "ak"
    ];

    private static tenthRoot(num: number): number {
    ...
    static abbreviate(num: number, forceZeroes = false): string {
        if (num < 1000) {
            return num.toString();
        }

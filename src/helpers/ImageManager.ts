...
export class ImageManager {
    ...
    private register(name: string, generator: () => any) {
        this.generators[name] = generator;
    }

    private registerDefaultImages() {
        this.register("topBottomGradient", () => {
            background(0, 0, 0, 0);
            fill(40, 75, 105);
            rect(0, 0, this.canvas.width, 2);
            rect(0, 48, this.canvas.width, 2);
            gradient(0, 2, this.canvas.width, 46, color(98, 147, 188), color(50, 93, 128));
            return get(0, 0, this.canvas.width, 50);
        });
